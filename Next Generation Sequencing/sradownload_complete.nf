...
// nextflow sradownload.nf --accession SRR16641643 --outdir results -profile singularity
// ls results
// ls results/SRR*

//firefox ACCESSION.html

// To reset: rm -r results/ work/

// make sure nextflow.config is in the same directory as sradownload.nf
// sradownload.nf is working for SRR16641643 (single-end reads)
// Try to run sradownload.nf on SRR18130206 (paired-end reads)
// cd *scriptdir*
